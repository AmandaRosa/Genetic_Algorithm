...
function [Filhos_pmx] = pmx (Filhos_elitismo, A, Individuos)

Filhos_pmx = Filhos_elitismo;
Pontos = length(A);
...
Metade = Individuos/2;
              ...
              for loop = 1:500
                ...
                filho_1 = zeros(1,length(Filhos_elitismo(1,:)));
                filho_2 = zeros(1,length(Filhos_elitismo(1,:)));
                ...
                Auxiliar1 = Filhos_elitismo(pai_1,:);
                Auxiliar2 = Filhos_elitismo(pai_2,:);
